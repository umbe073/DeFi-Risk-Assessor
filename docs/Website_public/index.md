...
The **Hodler Suite** is a Python-based engine for automated,
...
_“Hodler Suite – Pre‑Release Whitepaper”_ PDF in the repository root.
...
./bin/zensical serve -f mkdocs.yml -a <REDACTED_IP>:8000
```
