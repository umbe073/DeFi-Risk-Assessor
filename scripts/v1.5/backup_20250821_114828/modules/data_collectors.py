...
class BaseDataCollector(ABC):
    ...
    @abstractmethod
    def collect(self, token_address: str, symbol: str = None, **kwargs) -> Dict:
...
class MarketDataCollector(BaseDataCollector):
    ...
    def collect(self, token_address: str, symbol: str = None) -> Dict:
        """Collect market data"""
        data = {}
...
class SocialDataCollector(BaseDataCollector):
    ...
    def collect(self, token_address: str, symbol: str = None, token_name: str = None) -> Dict:
        """Collect social data"""
        data = {}
    ...
    def _get_twitter_data(self, symbol: str, token_name: str) -> Dict:
        ...
        try:
            ...
            params = {'query': f'#{symbol} OR {token_name}', 'granularity': 'day'}
    ...
    def _get_telegram_data(self, symbol: str, token_name: str) -> Dict:
    ...
    def _get_discord_data(self, symbol: str, token_name: str) -> Dict:
    ...
    def _get_reddit_data(self, symbol: str, token_name: str) -> Dict:
    ...
    def _get_bitcointalk_data(self, symbol: str, token_name: str) -> Dict:
    ...
    def _get_cointelegraph_data(self, symbol: str, token_name: str) -> Dict:
...
class SecurityDataCollector(BaseDataCollector):
    ...
    def _get_certik_data(self, token_address: str, symbol: str) -> Dict:
    ...
    def _get_defisafety_data(self, token_address: str, symbol: str) -> Dict:
        """Get DeFiSafety data"""
        try:
    ...
    def _get_alchemy_data(self, token_address: str, symbol: str) -> Dict:
        """Get Alchemy data"""
        try:
...
class ComplianceDataCollector(BaseDataCollector):
    ...
    def _get_scorechain_data(self, token_address: str, symbol: str) -> Dict:
    ...
    def _get_trm_data(self, token_address: str, symbol: str) -> Dict:
        """Get TRM Labs data"""
        try:
    ...
    def _get_sanctions_data(self, token_address: str, symbol: str) -> Dict:
...
class LiquidityDataCollector(BaseDataCollector):
    ...
    def _get_etherscan_data(self, token_address: str, symbol: str) -> Dict:
    ...
    def _get_defillama_data(self, token_address: str, symbol: str) -> Dict:
    ...
    def _get_oneinch_data(self, token_address: str, symbol: str) -> Dict:
...
class TransferDataCollector(BaseDataCollector):
    ...
    def _get_moralis_data(self, token_address: str, symbol: str) -> Dict:
    ...
    def _get_etherscan_transfer_data(self, token_address: str, symbol: str) -> Dict:
    ...
    def _get_bitquery_data(self, token_address: str, symbol: str) -> Dict:
