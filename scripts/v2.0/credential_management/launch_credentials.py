#!/usr/bin/env python3
"""
Wrapper script to launch the credential manager with proper environment setup
"""
...
def main():
    """Launch credential manager with proper environment"""
    ...
    # Path to the credential manager script
    script_path = os.path.join(os.path.dirname(__file__), 'gui_credentials.py')
    ...
    try:
        ...
        print(f"Error launching credential manager: {e}")
        sys.exit(1)
