...
class WebhookServer:
    ...
    def _normalize_chain_code(chain_value):
        ...
        key = str(chain_value or '').strip().lower()
        return alias_map.get(key, key if key else '')
...
def run_webhook_server():
    ...
    print("  • GET /webhook/health/deep/<chain> - Chain deep health check (eth|bsc|tron)")
