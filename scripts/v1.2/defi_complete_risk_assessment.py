...
class DeFiRiskAssessor:
    ...
    def score_aml_data(self, risk_report, token_address, chain):
        ...
        if data_sources == 0:
            score += 2  # Penalty for no AML data
            indicators.append("No AML data available")
        elif data_sources < 2:
    ...
    def score_compliance_data(self, risk_report, token_address, chain):
        ...
        try:
            ...
            # 1. EU Regulatory Compliance (Primary)
...
def fetch_vespia_authentication():
    ...
    try:
        # Try importing from credential_management package
